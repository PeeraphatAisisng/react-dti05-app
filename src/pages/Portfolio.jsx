  ...
  return (
    <>
      ...
      <main className="max-w-6xl mx-auto px-4 py-20">
        ...
        {lightbox && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm" role="dialog" aria-modal="true" onClick={() => setLightbox(null)}>
            <div className="lightbox-content bg-black/80 p-6 rounded-2xl max-w-4xl w-full" onClick={(e) => e.stopPropagation()}>
